...
However, the picture changes if the models are trained on larger datasets (14M-300M images). We find that large scale training trumps inductive bias. Our Vision Transformer (ViT) attains excellent results when pre-trained at sufficient scale and transferred to tasks with fewer datapoints. When pre-trained on the public ImageNet-21k dataset or the in-house JFT-300M dataset, ViT approaches or beats state of the art on multiple image recognition benchmarks. In particular, the best model reaches the accuracy of $8 8 . 5 5 \%$ on ImageNet, $9 0 . 7 2 \%$ on ImageNet-ReaL, $9 4 . 5 5 \%$ on CIFAR-100, and $7 7 . 6 3 \%$ on the VTAB suite of 19 tasks.
...
![](images/49e0b75962b4a843f16d69a5aa5cdf573702c06aedc2d1a4a03aaa4052fc36cb.jpg)

![](images/2549eb94f2ce1f85a4ee53b22f25c11a73985343d6ab7e046f88d57a7ddf5370.jpg)  
...
An overview of the model is depicted in Figure 1. The standard Transformer receives as input a 1D sequence of token embeddings. To handle 2D images, we reshape the image $\mathbf { x } \in \mathbb { R } ^ { H \times W \times \dot { C } }$ into a sequence of flattened 2D patches $\mathbf { x } _ { p } \in \mathbb { R } ^ { N \times ( P ^ { 2 } \cdot C ) }$ , where $( H , W )$ is the resolution of the original image, $C$ is the number of channels, $( P , P )$ is the resolution of each image patch, and $N = H W / P ^ { 2 }$ is the resulting number of patches, which also serves as the effective input sequence length for the Transformer. The Transformer uses constant latent vector size $D$ through all of its layers, so we flatten the patches and map to $D$ dimensions with a trainable linear projection (Eq. 1). We refer to the output of this projection as the patch embeddings.
...
![](images/267a0256ad6f26ed2883244bdd81eb5c8a2df9555b00ca503b7e4d1a129acc02.jpg)  
Figure 3: Transfer to ImageNet. While large ViT models perform worse than BiT ResNets (shaded area) when pre-trained on small datasets, they shine when pre-trained on larger datasets. Similarly, larger ViT variants overtake smaller ones as the dataset grows.

![](images/7ac6eb4ff9314a5917dcf55a8d0b64bc55aff69e59377dbb82aabcec6fac28fb.jpg)  
Figure 4: Linear few-shot evaluation on ImageNet versus pre-training size. ResNets perform better with smaller pre-training datasets but plateau sooner than ViT, which performs better with larger pre-training. ViT-b is ViT-B with all hidden dimensions halved.

![](images/c4d0d97a5b632c49912e4ed852485a4228fa191d781e25048040d8327b806e82.jpg)  
...
![](images/3764a2ee04df30355080f23c6da956251e8c6321f949b7f6da76fea9c3fb75e7.jpg)  
...
Xiaohua Zhai, Avital Oliver, Alexander Kolesnikov, and Lucas Beyer. $\mathrm { S ^ { 4 } L }$ : Self-Supervised Semi-Supervised Learning. In ICCV, 2019a.   
...
Table 3: Hyperparameters for training. All models are trained with a batch size of 4096 and learning rate warmup of $1 0 \mathrm { k }$ steps. For ImageNet we found it beneficial to additionally apply gradient clipping at global norm 1. Training resolution is 224.   
...
![](images/66439a18d01e1eebd4fb1d9ce0d2d47ba86aa253a7196737d7601de0903d80b3.jpg)  
...
![](images/cf19faab6ed3a208f22fcc2a02223389c922ec880aca89723a7e8af1deab4d18.jpg)

![](images/4bc3d9d23de4437cd4e6a350799ae55e56e6fc4a7882f36045c8ead075ccb79f.jpg)

![](images/64ea11fb25112dac09c5ad3b3ef0728ce0472868ea1bd72e03256555dd2a695d.jpg)  
...
![](images/c8b734f823018ec2c52f68d3319e5b8a60b10c5e9d2795562ff763bc09bec06f.jpg)  
...
![](images/bb30dc948d5d8ae3244d61cd41065780c3ce53a459aabfb06a32ddc5220a2d0e.jpg)

![](images/75435fecf8906ccba127c82a9e2dbf59668c1bfc5b5533a8cd504cab9ee7c242.jpg)  
...
We also evaluate our flagship ViT-H/14 model on the ObjectNet benchmark following the evaluation setup in Kolesnikov et al. (2020), resulting in $8 2 . 1 \%$ top-5 accuracy and $6 1 . 7 \%$ top-1 accuracy.

# D.10 VTAB BREAKDOWN

Table 9 shows the scores attained on each of the VTAB-1k tasks.

![](images/f10ac46b9029a9e4a0612cff8f1c72084f29b0aff3d54c8b93ad46c21738190f.jpg)  
