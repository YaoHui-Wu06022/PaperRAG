...
from paper_rag.retrieval.domains.top.prompt import top_route_prompt
...
def main() -> int:
    ...
    parser.add_argument("--validated", action="store_true", help="Print validated router payload instead of raw model output")
